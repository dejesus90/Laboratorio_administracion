...
<div class="ibox">
    ...
    <div class="ibox-body">
        <table class="table table-striped table-bordered table-hover table-responsive" id="example-table" cellspacing="0" width="100%">
            ...
            <tbody>
                @foreach($rechazados as $laboratorio)
                <tr>
                    ...
                    <td>
                        <ul>
                            @foreach($laboratorio->rechazados as $rechazado)
                            <li>{{$rechazado->motivo}}</li>
                            @endforeach
                        </ul>
                        
                    </td>
                    <td style="text-align:center">
                        <a class="btn btn-outline-danger btn-sm" role="button" href="{{ url('/validar-laboratorio/'.$laboratorio->id) }}">Activar</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
